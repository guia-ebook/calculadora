...
// Exemplo de uso
const total = 1000;              // Valor total a ser apostado
const old1 = 2.1;               // Valor da primeira 'old'
const old2 = 2.1;                 // Valor da segunda 'old'
...
console.log(`Lucro Garantido: ${resultado.lucroGarantido.toFixed(2)}`);
